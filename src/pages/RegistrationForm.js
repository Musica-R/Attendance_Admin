...
const RegistrationForm = () => {
    ...
    useEffect(() => {
        ...
        const fetchCompanies = async () => {
            ...
            try {
                ...
                const response = await fetch('https://hrms.mpdatahub.com/api/list-company');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(
                'https://hrms.mpdatahub.com/api/add-user',
                {
                    method: 'POST',
                    body: submitData
                }
            ...
            <div className="form-card">
                ...
                <form onSubmit={handleSubmit} className="registration-form">
                    ...
                    <div className="form-group">
                        ...
                        <input type="password" name="c_password" value={formData.c_password} onChange={handleChange} required />
                    ...
                    <div className="form-group">
                        ...
                        <input type="time" step="1" name="start_time" value={formData.start_time} onChange={handleChange} required />
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <input type="time" step="1" name="end_time" value={formData.end_time} min={formData.start_time} onChange={handleChange} required />
                    </div>
