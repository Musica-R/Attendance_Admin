  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(
          'Failed to create Notification: ' + (result.message || 'Unknown error')
        );
      }
    } catch (error) {
  ...
  const handleDelete = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(
          'Failed to Delete Notification: ' + (result.message || 'Unknown error')
        );
      }
    } catch (error) {
  ...
  return (
    <div className="form-containers fade-in-up">
        ...
        <div className="header-content">
          <div className="permission-title-group">
            ...
            <div>
              ...
              <p>
                Centralize notification creation and ensure timely communication of meetings and key events across your organization.
              </p>
            </div>
          </div>
        </div>
      ...
      {activeForm && createPortal(
        <div className="modal-overlays" onClick={() => setActiveForm(false)}>
          <div className="form-card modal" onClick={(e) => e.stopPropagation()}>
            <button className="close-btn" onClick={() => setActiveForm(false)}>
              ×
            </button>
      ...
      {notificationId && createPortal(
        <div className="modal-overlays" onClick={() => setNotificationId(null)}>
          <div
            className="form-card modal confirm-box"
            onClick={(e) => e.stopPropagation()}
          >
            ...
            <div className="confirm-actions">
              ...
              <button className="btn btn-danger" style={{background:'#5355E0'}} onClick={handleNotification}>
                Send
              </button>
            </div>
          </div>
